 ...
 **************************************************/
#define SEG4_GPU_DVFS_FREQ0			(890000)	/* KHz */
#define SEG4_GPU_DVFS_FREQ1			(500000)	/* KHz */
#define SEG4_GPU_DVFS_FREQ2			(400000)	/* KHz */

#define SEG4_GPU_DVFS_VOLT0		        (95000)	/* mV x 100 */
